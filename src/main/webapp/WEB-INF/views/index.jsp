...
<head>
	...
	<script type="text/javascript">
		...
		<%@ page import ="boot.LoadLocations"%>
		<%!
		List <Locations> locationList = new LoadLocations().load();
		%>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-line-chart fa-fw"></i> Trends and Distributions</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Analysis<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="morris.html">Exploration and Inference </a>
                                </li>
								<li>
                                    <a href="morris.html">Prediction and Causal analysis</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default col-lg-12 col-md-12">
                        ...
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="map_container" height="100%" onload="loadMap()"></div>
